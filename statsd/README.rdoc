...
Source: https://github.com/jellybob/kitchen/tree/statsd
...
* statsd/package_version : The version to use when creating the package. Defaults to 0.6.0-1
...
This package uses the "nodejs" package rather then attempting to build Node from source.
